...
int32_t ProviderClient::remove(const int32_t vtxno, const int32_t blkno)
{
...
int32_t ProviderClient::recv_remove()
{
...
int32_t ProviderClient::shift(const int32_t vtxno)
{
  send_shift(vtxno);
  return recv_shift();
}
...
int32_t ProviderClient::recv_shift()
{
...
int32_t ProviderClient::pop(const int32_t vtxno)
{
  send_pop(vtxno);
  return recv_pop();
}
...
int32_t ProviderClient::recv_pop()
{
