...
int32_t ProducerClient::remove(const int32_t vtxno, const int32_t blkno)
{
...
int32_t ProducerClient::recv_remove()
{
...
int32_t ProducerClient::shift(const int32_t vtxno)
{
  send_shift(vtxno);
  return recv_shift();
}
...
int32_t ProducerClient::recv_shift()
{
...
int32_t ProducerClient::pop(const int32_t vtxno)
{
  send_pop(vtxno);
  return recv_pop();
}
...
int32_t ProducerClient::recv_pop()
{
